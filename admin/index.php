...
<html>
    ...
    <body>
        ...
        <div class="container admin">
            <div class="row">
                <h1><strong>Productos Microtech</strong></h1>
                <h2><a href="insert.php" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-plus"></span> Agregar</a> <a href="../index.php" class="btn btn-success btn-lg"><span class="glyphicon glyphicon-align-justify"></span> Ver Productos</a></h2>
